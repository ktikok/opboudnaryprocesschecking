...
private:
  ...
  void Barrel(G4LogicalVolume* towerLogical[], G4LogicalVolume* PMTGLogical[], G4LogicalVolume* PMTfilterLogical[], G4LogicalVolume* PMTcellLogical[],
              G4LogicalVolume* PMTcathLogical[], 
  ...
  void fiberBarrel(G4int i, G4double deltatheta_, G4LogicalVolume* towerLogical[], 
  ...
  G4double clad_A_rMin;
  G4double clad_A_rMax;
  G4double clad_A_Dz  ;
  G4double clad_A_Sphi;
  G4double clad_A_Dphi;
